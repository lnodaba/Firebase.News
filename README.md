...
4. Create the model classes( [POC](https://stackoverflow.com/questions/250001/poco-definition) for the project inside the class library project. Important to have an ID field for the objects as they are eventualy entities.
5. Link the class library to the main MVC project (and aslo refference it to the Unit test project in case you have it) [Info](https://msdn.microsoft.com/en-us/library/ez524kew.aspx) Add Refference -> Project and check the DLL project jo want to refference to the main project. 
